...
public class PageClass extends CommonUtility {
  ...
  String searchbarFld = "//input[@title='Search'] | //div/textarea";
  ...
  String allProductPricesOnPage =
      "//a[@target='_blank']/span[@class='a-price']/span[@aria-hidden='true']/span[@class='a-price-whole']";
  ...
  String fiveStarProducts =
      "//div[@class='a-section a-spacing-small a-spacing-top-small']//i/span[text()='5.0 out of 5 stars']/preceding::h2[1]/a/span";
  ...
  public void selectCategory(String text) {
    waitForPageToLoad();
    WebElement drpdwn = driver.findElement(By.xpath(categoryDropdown));
  ...
  public void applyPriceFilter(int minValue, int maxValue) {
    ...
    writeToConsole(
        "INFO",
        "Applied filter for --> minimun value: " + minValue + " maximum value: " + maxValue);
  }
